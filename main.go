...
func init() {
	RootCmd.Flags().StringVarP(&endpoint, "endpoint", "e", "oss-cn-hangzhou.aliyuncs.com or localhost:9000", "Minio endpoint")
	...
	RootCmd.Flags().BoolVarP(&readOnly, "ro", "", true, "Read only")
